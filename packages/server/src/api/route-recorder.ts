// =============================================================================
// EMP EXIT — Route auto-discovery for the OpenAPI / Swagger docs
//
...
// then walk the mounted router's stack for its route layers. Exit mounts every
// API route on a single `v1` router (`v1.use('/auth', …)`) mounted at /api/v1,
// so call recordMounts on BOTH the app and that v1 router (basePrefix
